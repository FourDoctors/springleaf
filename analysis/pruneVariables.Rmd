...
save(train.X1.nu.pp, file = "../data/preprocessed/train.X1.nu.pp.Rdata")
save(train.X1.ec.pp, file = "../data/preprocessed/train.X1.ec.pp.Rdata")
save(train.X1.nz.pp, file = "../data/preprocessed/train.X1.nz.pp.Rdata")
save(train.X2.pp, file = "../data/preprocessed/train.X2.pp.Rdata")
save(train.X3.pp, file = "../data/preprocessed/train.X3.pp.Rdata")

save(test.X1.nu.pp, file = "../data/preprocessed/test.X1.nu.pp.Rdata")
save(test.X1.ec.pp, file = "../data/preprocessed/test.X1.ec.pp.Rdata")
save(test.X1.nz.pp, file = "../data/preprocessed/test.X1.nz.pp.Rdata")
save(test.X2.pp, file = "../data/preprocessed/test.X2.pp.Rdata")
save(test.X3.pp, file = "../data/preprocessed/test.X3.pp.Rdata")
